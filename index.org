...
Ultimately, we want to enable programmer to build elegant software systems that are reliable, maintainable, and composable---as well as being fun to write! We resist the temptation to compromise the principles of TLC in order to pursue high performance[fn:2].

#+begin_html
<h2 id="invitation">Join us</h2>
#+end_html

We welcome collaboration with researchers, programmers, autodidacts---you! Simply join the chat, [[https://groups.google.com/forum/#!forum/tlcsrc][mailing list]] or email [[mailto:src@steshaw.org][src@steshaw.org]].
