...
The Systems Research Centre[fn:1] that takes computation trinitarianism seriously---i.e the triplet of /Types/, /Logic/ ε̷ /Categories/. We want to build software systems that are reliable and so we put the triplet before low-level bit-twiddling tricks [fn:2].
