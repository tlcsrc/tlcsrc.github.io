...
We welcome collaboration with researchers, programmers, autodidacts, polymaths --- you! To become a member, simply join the [[https://gitter.im/triplet-src/public][chat room]] and introduce yourself. Alternatively email [[mailto:src@steshaw.org][src@steshaw.org]].
