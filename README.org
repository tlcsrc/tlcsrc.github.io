...
The Systems Research Centre[fn:1] that takes [[https://existentialtype.wordpress.com/2011/03/27/the-holy-trinity/][computational trinitarianism]] seriously---i.e the triplet of /Types/, /Logic/ ε̷ /Categories/. We want to build software systems that are reliable and so we put the triplet before low-level bit-twiddling tricks [fn:2].
...
Whether you're a programmer, logician or mathematician, we have a flavour of TLC for you---/Types/, /Logic/ or /Categories/. You can also enjoy a little /tender/ /loving/ /care/---we believe that when you care about usability[fn:4] you care about types, and logic, and categories.
...
[fn:4] Usability includes the notions of User Experience (UX) and [[http://developerexperience.org/][Developer Experience]] (DX).
